...
export interface EcosystemCategory {
    ...
    title: string;
    description: string;
    icon_name: 'Cpu' | 'Landmark' | 'Users' | 'Megaphone' | 'Scale' | 'Globe'; // Lucide icon names
...
export function getEcosystemCategories(): EcosystemCategory[] {
    return ECOSYSTEM_DATA;
}

export function getCategoryById(id: string): EcosystemCategory | undefined {
    return ECOSYSTEM_DATA.find(c => c.id === id);
}
