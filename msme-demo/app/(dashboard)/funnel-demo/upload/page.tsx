    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card>
                    <CardHeader>
                        <CardTitle>Bulk Upload (Demo)</CardTitle>
                        <CardDescription>Simulate uploading a CSV with 30 companies.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {!uploadComplete ? (
                            <div className="border-2 border-dashed rounded-lg p-10 text-center space-y-4">
                                <FileSpreadsheet className="h-12 w-12 mx-auto text-muted-foreground" />
                                <p className="text-sm text-muted-foreground">demo_companies_v1.csv (Pre-loaded)</p>
                                <Button onClick={handleMockUpload} disabled={mockUploading}>
                                    {mockUploading ? "Uploading..." : "Simulate CSV Upload"}
                                </Button>
                            </div>
                        ) : (
                ...
                <Card className="opacity-50 pointer-events-none">
                    <CardHeader>
                        ...
                        <CardDescription>Disabled in Demo Mode</CardDescription>
                    </CardHeader>
                    <CardContent>
