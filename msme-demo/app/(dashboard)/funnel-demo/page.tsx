...
import { DEMO_COMPANIES, getCompaniesByStage } from '@/lib/demo-data/companies';
...
export default function DemoFunnelOverviewPage() {
    ...
    const stage5Plus = getCompaniesByStage(5).length;
    const stage6Plus = getCompaniesByStage(6).length;
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">30 loaded in demo</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="pb-2 flex flex-row items-center justify-between space-y-0">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-4 text-center">
                        <Button variant="outline" size="sm">View All 30 Companies</Button>
                    </div>
                </CardContent>
            </Card>
        </div>
